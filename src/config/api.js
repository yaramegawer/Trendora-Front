...
export const API_CONFIG = {
  BASE_URL:
    import.meta.env.VITE_API_URL || "https://trendora-nine.vercel.app/api",
  TIMEOUT: 10000,
  ENDPOINTS: {
    USER: {
      LOGIN: "/user/log_in",
    ...
    IT: {
      ...
      TICKETS: "/it/tickets",
      LEAVES: "/it/leaves",
      DEPARTMENT_LEAVES: "/it/ItLeaves/:departmentId",
      UPDATE_LEAVE: "/it/leaves/:id",
      DELETE_LEAVE: "/it/leaves/:id",
    },
    OPERATION: {
      ...
      DEPARTMENT_LEAVES: "/operation/OperationLeaves/:departmentId",
      UPDATE_LEAVE: "/operation/leaves/:id",
      DELETE_LEAVE: "/operation/leaves/:id",
    },
    MARKETING: {
      ...
      UPDATE_LEAVE: "/digitalMarketing/leaves/:id",
      DELETE_LEAVE: "/digitalMarketing/leaves/:id",
      DEPARTMENT_LEAVES:
        "/digitalMarketing/DigitalMarketingLeaves/:departmentId",
